...
const styles ={
    ...
    buyButton: `w-[20%] h-[50px] bg-[#000] mt-[40px] rounded-lg p-[10px] flex mx-auto text-white justify-center items-center cursor-pointer`,
        ...
        { isLoading ? (
              <>  
                ...
                <>
                    ...
                    <div className={styles.title}>Buy More Franky Coins Here</div>
                    ...
                    <>
                        <div className={styles.success}>
                            Transaction Successfull check out your receipt below
                        </div>
